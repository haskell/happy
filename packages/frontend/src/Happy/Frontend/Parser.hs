...
{-# INLINE happyOut5 #-}
newtype HappyWrap6 = HappyWrap6 (AbsSyn)
happyIn6 :: (AbsSyn) -> (HappyAbsSyn )
...
{-# INLINE happyOut7 #-}
newtype HappyWrap8 = HappyWrap8 (Rule)
happyIn8 :: (Rule) -> (HappyAbsSyn )
...
{-# INLINE happyOut11 #-}
newtype HappyWrap12 = HappyWrap12 (Prod)
happyIn12 :: (Prod) -> (HappyAbsSyn )
...
{-# INLINE happyOut21 #-}
newtype HappyWrap22 = HappyWrap22 ((String,String))
happyIn22 :: ((String,String)) -> (HappyAbsSyn )
