...
> type P a = Prelude.String -> Prelude.Int -> ParseResult a
...
>	(Let 1 "x" (Exp1 (Term (Factor (Int 2)))) (Exp1 (Term (Times (Factor (Var "x")) (Brack (Exp1 (Minus (Term (Factor (Var "x"))) (Factor (Int 2))))))))) -> Prelude.print "Test works\n";
