...
data Tok = Plus | Divide | Num Prelude.Int deriving Prelude.Show

data Syn = Plus' Syn Syn | Divide' Syn Syn | Num' Prelude.Int deriving Prelude.Show

-- due to a bug in conflict resolution, this caused a parse error:
tokens1 = [Num 6, Divide, Num 7, Plus, Num 8]

main = Prelude.print (parse tokens1)
}
