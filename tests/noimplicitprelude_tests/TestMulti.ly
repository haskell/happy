...
> data Exp  = Let Prelude.String Exp Exp | Exp1 Exp1
...
> runCalcExp :: Prelude.String -> Exp
> runCalcExp = calcExp Prelude.. lexer

> runCalcTerm :: Prelude.String -> Term
> runCalcTerm = calcTerm Prelude.. lexer
...
>	(Times (Factor (Int 2)) (Brack (Exp1 (Plus (Term (Factor (Int 3))) (Factor (Int 1)))))) -> Prelude.print "Test works\n";
