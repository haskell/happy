...
sep_by1(p,sep) :: { Prelude.Int }
  : sep_by1(p,sep) sep p                                                      { 10 }
  | p                                                                         { 11 }

sep_by(p,sep) :: { Prelude.Int }
  : sep_by1(p,sep)                                                            { 12 }
  | {- empty -}                                                               { 13 }

sep_by1T(p,sep) :: { Prelude.Int }
  : sep_by1(p,sep) sep                                                        { 14 }
  | sep_by1(p,sep)                                                            { 15 }

sep_byT(p,sep) :: { Prelude.Int }
  : sep_by1T(p,sep)                                                           { 16 }
  | {- empty -}                                                               { 17 }

source_file :: { Prelude.Int }
  : inner_attrs many(mod_item)                                                { 18 }
  |             many(mod_item)                                                { 19 }

outer_attribute :: { Prelude.Int }
  : '#' '[' mod_path token_stream ']'                                         { 20 }
  | outerDoc                                                                  { 21 }

inner_attribute :: { Prelude.Int }
  : '#' '!' '[' mod_path token_stream ']'                                     { 22 }
  | '#!'    '[' mod_path token_stream ']'                                     { 23 }
  | innerDoc                                                                  { 24 }

inner_attrs :: { Prelude.Int }
...
lifetime_mut :: { Prelude.Int }
  : lifetime mut                                                              { 124 }
  | lifetime                                                                  { 125 }
  |          mut                                                              { 126 }
  | {- empty -}                                                               { 127 }

fn_decl(arg) :: { Prelude.Int }
  : '(' sep_by1(arg,',') ',' '...' ')' ret_ty                                 { 128 }
  | '(' sep_byT(arg,',')           ')' ret_ty                                 { 129 }

fn_decl_with_self_general :: { Prelude.Int }
  : '(' arg_self_general ',' sep_byT(arg_general,',') ')' ret_ty              { 130 }
  | '(' arg_self_general                              ')' ret_ty              { 131 }
  | '('                                               ')' ret_ty              { 132 }

fn_decl_with_self_named :: { Prelude.Int }
...
ty_param_bound :: { Prelude.Int }
  : lifetime                                                                  { 138 }
  | poly_trait_ref                                                            { 139 }

poly_trait_ref_mod_bound :: { Prelude.Int }
  : poly_trait_ref                                                            { 140 }
  | '?' poly_trait_ref                                                        { 141 }

ty_param_bound_mod :: { Prelude.Int }
  : ty_param_bound                                                            { 142 }
  | '?' poly_trait_ref                                                        { 143 }
...
arg_self_general :: { Prelude.Int }
  : mut self                                                                  { 165 }
  |     self ':' ty                                                           { 166 }
  | mut self ':' ty                                                           { 167 }
  | arg_general                                                               { 168 }

arg_self_named :: { Prelude.Int }
  :                  self                                                     { 169 }
  |              mut self                                                     { 170 }
  | '&'              self                                                     { 171 }
  | '&' lifetime     self                                                     { 172 }
...
lit_or_path :: { Prelude.Int }
  : expr_path                                                                 { 218 }
  | expr_qual_path                                                            { 219 }
  | '-' lit_expr                                                              { 220 }
  |     lit_expr                                                              { 221 }

pat_fields :: { Prelude.Int }
  : sep_byT(pat_field,',')                                                    { 222 }
  | sep_by1(pat_field,',') ',' '..'                                           { 223 }

pat_field :: { Prelude.Int }
  :     binding_mode ident                                                    { 224 }
  | box binding_mode ident                                                    { 225 }
  |     binding_mode ident ':' pat                                            { 226 }

binding_mode1 :: { Prelude.Int }
  : ref mut                                                                   { 227 }
  | ref                                                                       { 228 }
  |     mut                                                                   { 229 }

binding_mode :: { Prelude.Int }
  : binding_mode1                                                             { 230 }
  | {- empty -}                                                               { 231 }

gen_expression(lhs,rhs,rhs2) :: { Prelude.Int }
  : ntExpr                                                                    { 232 }
  | lit_expr                                                                  { 233 }
  | '[' sep_byT(expr,',') ']'                                                 { 234 }
...
left_gen_expression(lhs,rhs,rhs2) :: { Prelude.Int }
...
postfix_blockexpr(lhs) :: { Prelude.Int }
  : lhs '?'                                                                   { 302 }
...
lit_expr :: { Prelude.Int }
  : lit                                                                       { 326 }

block_expr :: { Prelude.Int }
  : block_like_expr                                                           { 327 }
  | inner_attrs_block                                                         { 328 }
  | unsafe inner_attrs_block                                                  { 329 }


block_like_expr :: { Prelude.Int }
  : if_expr                                                                   { 330 }
...
arm_guard :: { Prelude.Int }
  : {- empty -}                                                               { 353 }
  | if expr                                                                   { 354 }

comma_arms :: { Prelude.Int }
  : {- empty -}                                                               { 355 }
  | ','                                                                       { 356 }
  | ',' arms                                                                  { 357 }

expr_arms :: { Prelude.Int }
...
inner_attrs_block :: { Prelude.Int }
  : block                                                                     { 415 }
  | '{' inner_attrs '}'                                                       { 416 }
  | '{' inner_attrs stmts_possibly_no_semi '}'                                { 417 }

gen_item(vis) :: { Prelude.Int }
...
impl_items :: { Prelude.Int }
  :             many(impl_item)                                               { 487 }
  | inner_attrs many(impl_item)                                               { 488 }

impl_item :: { Prelude.Int }
...
token_stream :: { Prelude.Int }
  : {- empty -}                                                               { 541 }
  | some(token_tree)                                                          { 542 }

token_tree :: { Prelude.Int }
  : ntTT                                                                      { 543 }
  | '(' token_stream ')'                                                      { 544 }
  | '{' token_stream '}'                                                      { 545 }
  | '[' token_stream ']'                                                      { 546 }
...
export_attribute :: { Prelude.Int }
  : inner_attribute                                                           { 663 }
  | outer_attribute                                                           { 664 }

export_block :: { Prelude.Int }
  : ntBlock                                                                   { 665 }
  | safety '{' '}'                                                            { 666 }
  | safety '{' stmts_possibly_no_semi '}'                                     { 667 }

export_ty :: { Prelude.Int }
  : ty                                                                        { 668 }
  | impl_ty                                                                   { 669 }
...
type P a = Prelude.String -> Prelude.Either Prelude.String (a, Prelude.String)

bindP :: P a -> (a -> P b) -> P b
bindP p f s = case p s of
                Prelude.Left m -> Prelude.Left m
                Prelude.Right (x,s') -> f x s'

returnP :: a -> P a
returnP x s = Prelude.Right (x,s)

parseError :: Prelude.Show b => b -> P a
parseError b _ = Prelude.Left ("Syntax error: the symbol `" Prelude.++ Prelude.show b Prelude.++ "' does not fit here")
...
data Token
  ...
  | CloseBracket
  | CloseBrace
  | IdentTok Prelude.String
  | Underscore
  | LifetimeTok Prelude.String
  | Space
  | InnerDoc
  | OuterDoc
  | Shebang
  | Eof
  | ByteTok Prelude.String
  | CharTok Prelude.String
  | IntegerTok Prelude.String
  | FloatTok Prelude.String
  | StrTok Prelude.String
  | StrRawTok Prelude.String
  | ByteStrTok Prelude.String
  | ByteStrRawTok Prelude.String
  | Interpolated Prelude.Int
  deriving Prelude.Show


-- This is an intentionally simplfied tokenizer
lexNonSpace :: P Token
lexNonSpace "" = Prelude.Right (Eof, "")
lexNonSpace ('.':cs) = Prelude.Right (Dot, cs)
lexNonSpace ('+':cs) = Prelude.Right (Plus, cs)
lexNonSpace (';':cs) = Prelude.Right (Semicolon, cs)
lexNonSpace (',':cs) = Prelude.Right (Comma, cs)
lexNonSpace ('=':cs) = Prelude.Right (Equal, cs)
lexNonSpace ('{':cs) = Prelude.Right (OpenBrace, cs)
lexNonSpace ('}':cs) = Prelude.Right (CloseBrace, cs)
lexNonSpace ('(':cs) = Prelude.Right (OpenParen, cs)
lexNonSpace (')':cs) = Prelude.Right (CloseParen, cs)
lexNonSpace (c:cs)
  | isSpace c = lexNonSpace cs
  | isNumber c = let (tok,cs') = Prelude.span isNumber (c:cs) in Prelude.Right (IntegerTok tok, cs')
  | isAlpha c = let (tok,cs') = Prelude.span isAlphaNum (c:cs) in Prelude.Right (IdentTok tok, cs')
  | Prelude.otherwise = Prelude.Left ("Unexpected character: `" Prelude.++ [c] Prelude.++ "'")


main = case parseStmt "union.1 + 2;" of
         Prelude.Right (394, "") -> Prelude.pure ()
