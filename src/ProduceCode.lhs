...
>                 | otherwise = str "HappyPrelude.Int"
>
...
>       . str "\n\t= HappyTerminal " . token
>       . str "\n\t| HappyErrorToken HappyPrelude.Int\n"
>       . interleave "\n"
...
>       = produceActionArray
>       . produceReduceArray
>       . str "happy_n_terms = " . shows n_terminals . str " :: HappyPrelude.Int\n"
>       . str "happy_n_nonterms = " . shows n_nonterminals . str " :: HappyPrelude.Int\n\n"
>
>    produceExpListPerState
>       = produceExpListArray
...
>       . str "        bit_start = st HappyPrelude.* " . str (show nr_tokens) . str "\n"
>       . str "        bit_end = (st HappyPrelude.+ 1) HappyPrelude.* " . str (show nr_tokens) . str "\n"
>       . str "        read_bit = readArrayBit happyExpList\n"
>       . str "        bits = HappyPrelude.map read_bit [bit_start..bit_end HappyPrelude.- 1]\n"
>       . str "        bits_indexed = HappyPrelude.zip bits [0.."
>                                        . str (show (nr_tokens - 1)) . str "]\n"
>       . str "        token_strs_expected = HappyPrelude.concatMap f bits_indexed\n"
>       . str "        f (HappyPrelude.False, _) = []\n"
>       . str "        f (HappyPrelude.True, nr) = [token_strs HappyPrelude.!! nr]\n"
>       . str "\n"
...
>       | otherwise
>           = str "happyActOffsets :: Happy_Data_Array.Array HappyPrelude.Int HappyPrelude.Int\n"
>           . str "happyActOffsets = Happy_Data_Array.listArray (0,"
>               . shows n_states . str ") (["
>           . interleave' "," (map shows act_offs)
>           . str "\n\t])\n\n"
>
>           . str "happyGotoOffsets :: Happy_Data_Array.Array HappyPrelude.Int HappyPrelude.Int\n"
>           . str "happyGotoOffsets = Happy_Data_Array.listArray (0,"
>               . shows n_states . str ") (["
>           . interleave' "," (map shows goto_offs)
>           . str "\n\t])\n\n"
>
>           . str "happyAdjustOffset :: HappyPrelude.Int -> HappyPrelude.Int\n"
>           . str "happyAdjustOffset = HappyPrelude.id\n\n"
>
>           . str "happyDefActions :: Happy_Data_Array.Array HappyPrelude.Int HappyPrelude.Int\n"
>           . str "happyDefActions = Happy_Data_Array.listArray (0,"
>               . shows n_states . str ") (["
>           . interleave' "," (map shows defaults)
>           . str "\n\t])\n\n"
>
>           . str "happyCheck :: Happy_Data_Array.Array HappyPrelude.Int HappyPrelude.Int\n"
>           . str "happyCheck = Happy_Data_Array.listArray (0,"
>               . shows table_size . str ") (["
>           . interleave' "," (map shows check)
>           . str "\n\t])\n\n"
>
>           . str "happyTable :: Happy_Data_Array.Array HappyPrelude.Int HappyPrelude.Int\n"
...
>           . str "\"#\n\n" --"
>       | otherwise
>           = str "happyExpList :: Happy_Data_Array.Array HappyPrelude.Int HappyPrelude.Int\n"
...
>                . token
>                . str "], [HappyPrelude.String]) -> "
>                . str monad_tycon
>                . str " a\n"
>                . str "happyError' = "
>                . str (if use_monad then "" else "HappyIdentity HappyPrelude.. ")
>                . errorHandler . str "\n"
>               _ ->
>                let
>                  happyParseSig
...
>                      . str " => Happy_Data_Array.Array HappyPrelude.Int (" . intMaybeHash
>                      . str " -> " . str token_type' . str " -> " . intMaybeHash
>                      . str " -> Happy_IntList -> HappyStk " . happyAbsSyn
>                      . str " -> " . pty . str " " . happyAbsSyn . str ")\n"
>                      . str "\n"
...
>         . str "HappyPrelude.sequence_ conds; "
>         . str "HappyPrelude.return (". str defaultAttr . str " attrs) }}"
>       monadAE name
>         = str name . str " toks = "
>         . str "do { "
...
>         . str "x = HappyPrelude.foldr HappyPrelude.seq attrs conds; "
...
>         attrError (ident,_) = str ident . str " = HappyPrelude.error \"invalid reference to attribute '" . str ident . str "'\""
>         attrHeader =
